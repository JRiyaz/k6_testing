...
export default (authToken) => {
    ...
    group('Template | Add or Modify', function () {
        http.batch([
            ...
            ["GET", `${LETTERS_URL}get_employer_list?query=test&payor_idn=5347&payor_idn=89328&payor_idn=5349&payor_idn=84424&payor_idn=111&max_results=10&payor_access=P`, null, bearer_token],
            ["GET", `${LETTERS_URL}get_group_list?query=test&emp_idn=60036&emp_idn=56891&emp_idn=189&emp_idn=56891&max_results=10`, null, bearer_token],
